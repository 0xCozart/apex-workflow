...
function resolveTargetPath(targetRoot, rawPath) {
  return resolveInsideRoot(targetRoot, rawPath, { label: "codebase map path", file: true }).absolute;
}
...
function gitHead(targetRoot) {
  const result = spawnSync("git", ["-C", targetRoot, "rev-parse", "HEAD"], {
    encoding: "utf8",
  });
